    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 50%, #f8f7f4 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: '2rem', fontWeight: 700, color: '#0f0f0f', marginBottom: '6px' }}>XpenseAI</h1>
          <p style={{ color: '#94a3b8', fontSize: '14px' }}>Your AI-powered expense tracker</p>
        </div>

        <div style={{ background: '#fff', borderRadius: '24px', border: '1px solid #e8e4dc', padding: '2rem', boxShadow: '0 8px 32px rgba(0,0,0,0.06)' }}>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.5rem', color: '#0f0f0f', marginBottom: '4px' }}>Create account</h2>
          <p style={{ color: '#94a3b8', fontSize: '13px', marginBottom: '1.5rem' }}>Start tracking your expenses</p>
