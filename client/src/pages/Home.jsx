...
export default function Home() {
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#fff', fontFamily: "'DM Sans', sans-serif", overflowX: 'hidden' }}>
            ...
            {/* Navbar */}
            <nav style={{ padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #f1f5f9', position: 'sticky', top: 0, background: '#fff', zIndex: 100 }}>
                ...
                {/* Right side — stacks nicely on mobile */}
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                    <Link to="/login" style={{ fontSize: '13px', color: '#555', textDecoration: 'none', fontWeight: 500, padding: '7px 12px', border: '1px solid #e5e7eb', borderRadius: '8px', whiteSpace: 'nowrap' }}>
                        Login
                    </Link>
                    <Link to="/register" style={{ fontSize: '13px', color: '#fff', textDecoration: 'none', padding: '7px 12px', background: '#2563eb', borderRadius: '8px', fontWeight: 600, whiteSpace: 'nowrap' }}>
                        Sign up
                    </Link>
                </div>
            </nav>
